    ...
    return (
        <div className="relative mb-8">
            ...
            <button 
                ...
                className="absolute right-0 z-10 inline-flex items-center justify-center w-8 h-60 top-1/2 transform -translate-y-1/2 text-white bg-black bg-opacity-60 cursor-pointer hover:bg-opacity-75"
            ...
            <div 
                ref={scrollRef} 
                className="flex overflow-x-scroll py-4 space-x-4 scrollbar-hide pl-8 pr-8"
